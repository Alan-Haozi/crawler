...
public interface CrawlerDataDao {
    ...
    /*public abstract*/ boolean addCrawlerData(String url, String content, LocalDateTime time, String username, int success, String title);//增操作

    /*public abstract*/ boolean updateById(int id, String url, String content, LocalDateTime time, String username, int success, String title);//改操作
